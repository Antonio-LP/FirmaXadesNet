...
namespace Microsoft.Xades
{
    ...
    public class XadesSignedXml : System.Security.Cryptography.Xml.SignedXml
    {
        ...
        private SignatureDescription GetSignatureDescription()
        {
			...
			SignatureDescription description = CryptoConfig.CreateFromName(this.SignedInfo.SignatureMethod,null) as SignatureDescription;
            ...
            if (description == null)
            {
				...
				{
					CryptoConfig.AddAlgorithm(typeof(Microsoft.Xades.CustomRSAPKCS1SHA1SignatureDescription), "http://www.w3.org/2000/09/xmldsig#rsa-sha1");
				}
